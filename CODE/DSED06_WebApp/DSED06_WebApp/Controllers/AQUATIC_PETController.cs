...
namespace DSED06_WebApp.Controllers
{
    public class AQUATIC_PETController : Controller
    {
        ...
        {
            return View(db.AQUATIC_PET.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "ID_PK,COMMON,SCIENTIFIC")] AQUATIC_PET aQUATIC_PET)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_PK,COMMON,SCIENTIFIC")] AQUATIC_PET aQUATIC_PET)
        {
            if (ModelState.IsValid)
            {
